...
const authSlice = createSlice({
    //Imp line - so jo state variables ham ynha pr define kr rahe ho woh phle store ke aandar pass krenge , aur phir store ko koi bhi use kr payega using these reducers 
